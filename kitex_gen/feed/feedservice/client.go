...
type Client interface {
	...
	GetVideoById(ctx context.Context, Req *feed.VideoIdRequest, callOptions ...callopt.Option) (r *entity.Video, err error)
}
...
func (p *kFeedServiceClient) GetVideoById(ctx context.Context, Req *feed.VideoIdRequest, callOptions ...callopt.Option) (r *entity.Video, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
