...
var GetVideoByIdResult_Success_DEFAULT *entity.Video
...
func (p *GetVideoByIdResult) GetSuccess() *entity.Video {
	if !p.IsSetSuccess() {
...
func (p *kClient) GetVideoById(ctx context.Context, Req *feed.VideoIdRequest) (r *entity.Video, err error) {
