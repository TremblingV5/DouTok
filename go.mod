...
require (
	...
	github.com/TremblingV5/box v0.0.3
...
replace github.com/apache/thrift => github.com/apache/thrift v0.13.0 // lock version of Thrift. Thrift has a breaking change in v0.14.0
