...
func newVideoCount(db *gorm.DB, opts ...gen.DOOption) videoCount {
	...
	_videoCount.VideoId = field.NewUint64(tableName, "video_id")
	_videoCount.FavCount = field.NewUint64(tableName, "fav_count")
...
func (v *videoCount) updateTableName(table string) *videoCount {
	...
	v.VideoId = field.NewUint64(table, "video_id")
