...
type QueryIsFavoriteService struct {
	ctx context.Context
}

func NewQueryIsFavoriteService(ctx context.Context) *QueryIsFavoriteService {
	return &QueryIsFavoriteService{ctx: ctx}
}

func (s *QueryIsFavoriteService) QueryIsFavorite(user_id int64, videoIdList []int64) (map[int64]bool, error) {
