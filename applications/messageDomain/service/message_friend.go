...
func (s *MessageFriendService) MessageFriendList(req *message.DouyinFriendListMessageRequest) (error, map[int64]*entity.Message) {
	// 从 redis 缓存读 key:会话id value: 消息内容
	result := make(map[int64]*entity.Message)
