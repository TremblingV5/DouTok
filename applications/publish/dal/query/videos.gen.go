...
func newVideo(db *gorm.DB, opts ...gen.DOOption) video {
	...
	_video.ID = field.NewUint64(tableName, "id")
	_video.AuthorID = field.NewUint64(tableName, "author_id")
	...
	_video.FavCount = field.NewUint64(tableName, "fav_count")
	_video.ComCount = field.NewUint64(tableName, "com_count")
...
type video struct {
	...
	FavCount  field.Uint64
	ComCount  field.Uint64
...
func (v *video) updateTableName(table string) *video {
	...
	v.AuthorID = field.NewUint64(table, "author_id")
	v.Title = field.NewString(table, "title")
	v.VideoUrl = field.NewString(table, "video_url")
	v.CoverUrl = field.NewString(table, "cover_url")
	v.FavCount = field.NewUint64(table, "fav_count")
	v.ComCount = field.NewUint64(table, "com_count")
...
func (v *video) fillFieldMap() {
	...
	v.fieldMap["fav_count"] = v.FavCount
	v.fieldMap["com_count"] = v.ComCount
